                    ...
                    <div id="registroColonia" tabindex="-1" aria-hidden="true"
                        ...
                        <div class="relative w-full max-w-2xl max-h-full">
                            ...
                            <div class="relative bg-white rounded-lg shadow">
                                ...
                                <form accept-charset="utf-8" method="POST" action="{{ route('colonias.store') }}">
                                    @csrf
                                    <div class="px-6">
                                ...
                                <tr class="bg-teal-500 hover:bg-teal-700 text-white">
                                    ...
                                    <td class="text-center">
                                        <div class="inline-flex p-2 space-x-3">
                                            ...
                                            <button data-modal-target="editarColonia{{ $colonia->id }}"
                                                data-modal-toggle="editarColonia{{ $colonia->id }}" type="button"
                                            ...
                                            <div id="editarColonia{{ $colonia->id }}" tabindex="-1" aria-hidden="true"
                                                class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                <div class="relative w-full max-w-2xl max-h-full">
                                                    <!-- Modal content -->
                                                    <div class="relative bg-white rounded-lg shadow">
                                                        ...
                                                        <div
                                                            ...
                                                            <button type="button"
                                                                class="text-white bg-transparent hover:bg-custom-header hover:text-custom-linksmenu rounded-lg w-8 h-8 ml-auto inline-flex justify-center items-center"
                                                                data-modal-hide="editarColonia{{ $colonia->id }}">
                                            ...
                                            <form method="POST"
                                                action="{{ route('colonias.destroy', $colonia->id) }}">
                                                @csrf
                                                @method('delete')
