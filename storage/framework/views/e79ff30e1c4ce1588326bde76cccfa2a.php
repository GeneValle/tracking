        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-purple-300 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="mt-4 ml-6 font-bold text-4xl text-slate-950 flex items-center">
                    ...
                    <!-- Modal toggle -->
                    <button data-modal-target="registroColonia" data-modal-toggle="registroColonia"
                    ...
                    <div id="registroColonia" tabindex="-1" aria-hidden="true"
                            ...
                            <div class="relative bg-white rounded-lg shadow">
                                ...
                                <div class="bg-custom-morado flex items-start justify-between p-4 border-b rounded-t">
                                    ...
                                    <button type="button"
                                        ...
                                        data-modal-hide="registroColonia">
                                ...
                                <form accept-charset="utf-8" method="POST" action="<?php echo e(route('colonias.store')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <div class="px-6">
                                        <label for="colonia" class="text-base text-custom-morado">Colonia</label>
                                        <div class="my-2">
                ...
                <div class="my-4 ml-6 font-bold text-2xl text-custom-morado text-center">
                    Listado de colonias disponibles
                </div>
                                ...
                                <tr class="bg-teal-500 hover:bg-teal-700 text-white">
                                    ...
                                    <td class="text-center">
                                        <div class="inline-flex p-2 space-x-3">
                                            ...
                                            <button data-modal-target="editarColonia<?php echo e($colonia->id); ?>"
                                                data-modal-toggle="editarColonia<?php echo e($colonia->id); ?>" type="button"
                                            ...
                                            <div id="editarColonia<?php echo e($colonia->id); ?>" tabindex="-1" aria-hidden="true"
                                                class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                <div class="relative w-full max-w-2xl max-h-full">
                                                    <!-- Modal content -->
                                                    <div class="relative bg-white rounded-lg shadow">
                                                        ...
                                                        <div
                                                            ...
                                                            <button type="button"
                                                                class="text-white bg-transparent hover:bg-custom-header hover:text-custom-linksmenu rounded-lg w-8 h-8 ml-auto inline-flex justify-center items-center"
                                                                data-modal-hide="editarColonia<?php echo e($colonia->id); ?>">
                                                        ...
                                                        <form accept-charset="utf-8" method="POST"
                                                            action="<?php echo e(route('colonias.update', $colonia)); ?>">
                                                            <?php echo csrf_field(); ?>
                                                            ...
                                                            <div class="px-6">
                                                                ...
                                                                <div class="my-2">
                                                                    <input type="text"
                                                                        class="rounded-lg w-full text-custom-morado"
                                                                        name="colonia" id="colonia"
                                                                        value="<?php echo e($colonia->colonia); ?>">
                                                                </div>
                                                                ...
                                                                <div class="my-2">
                                                                    <input type="number"
                                                                        ...
                                                                        value="<?php echo e($colonia->codPostal); ?>">
                                                                </div>
                                                            </div>
                                            ...
                                            <form method="POST"
                                                action="<?php echo e(route('colonias.destroy', $colonia->id)); ?>">
                                                <?php echo csrf_field(); ?>
                                                ...
                                                <button type="submit"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" height="2em"
                                                        class="m-auto" viewBox="0 0 512 512">
                                                        <path
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ANDF\jetStream\resources\views\colonias.blade.php ENDPATH**/ ?>