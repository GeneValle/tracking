...
<?php endif; ?>
    ...
    <div class="mt-5 md:mt-0 md:col-span-2">
        <form wire:submit="<?php echo e($submit); ?>">
            <div class="px-4 py-5 bg-purple-300 sm:p-6 shadow <?php echo e(isset($actions) ? 'sm:rounded-tl-md sm:rounded-tr-md' : 'sm:rounded-md'); ?>">
            ...
            <!--[if BLOCK]><![endif]--><?php if(isset($actions)): ?>
                <div class="flex items-center justify-end px-4 py-3 bg-purple-300 border-t-2 border-gray-50 text-end sm:px-6 shadow sm:rounded-bl-md sm:rounded-br-md">
                    <?php echo e($actions); ?>
...
<?php /**PATH C:\xampp\htdocs\ANDF\jetStream\resources\views/components/form-section.blade.php ENDPATH**/ ?>