    ...
    <div class="py-5">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-purple-300 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <form method="POST" id="filtroForm" action="<?php echo e(route('reporteAsesores.obtenerDatosAsesoresGrafica')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <script>
        $(document).ready(function() {
            function obtenerYRenderizarDatos() {
                $.ajax({
                    url: '<?php echo e(route("reporteAsesores.obtenerDatosGeneralesGrafica")); ?>',
                    type: 'GET',
                    dataType: 'json',
