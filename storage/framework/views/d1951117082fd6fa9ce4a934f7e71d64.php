...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('description', null, []); ?> 
        <?php echo e(__('Administre y cierre sesión en sus sesiones activas en otros navegores y dispositivos.')); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('content', null, []); ?> 
        <div class="max-w-xl text-sm text-gray-600">
            <?php echo e(__('Si es necesario, puedes cerrar sesión de todas las sesiones abiertas en los navegadores a través de tus dispositivos. Algunas de sus sesiones recientes se enumeran a continuación; sin embargo, esta lista puede no ser exhaustiva. Si cree que su cuenta ha sido comprometida, también debe actualizar su contraseña.')); ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ms-3">
                            <div class="text-sm text-gray-600">
                                <?php echo e($session->agent->platform() ? $session->agent->platform() : __('Descnonicdo')); ?> - <?php echo e($session->agent->browser() ? $session->agent->browser() : __('Descnonicdo')); ?>
                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    <?php else: ?>
                                        <?php echo e(__('Último activo')); ?> <?php echo e($session->last_active); ?>
...
<?php $component->withAttributes(['wire:model.live' => 'confirmingLogout']); ?>
             ...
             <?php $__env->slot('content', null, []); ?> 
                <?php echo e(__('Por favor ingresa tu contraseña si te gustaría cerrar sesión en todos sus dispositivos.')); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ANDF\jetStream\resources\views/profile/logout-other-browser-sessions-form.blade.php ENDPATH**/ ?>