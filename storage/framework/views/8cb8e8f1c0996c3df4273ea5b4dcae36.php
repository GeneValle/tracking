...
<?php endif; ?>
    ...
    <div class="mt-5 md:mt-0 md:col-span-2">
        <div class="px-4 py-5 sm:p-6 bg-purple-300 shadow sm:rounded-lg">
            <?php echo e($content); ?>

        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\ANDF\jetStream\resources\views\components\action-section.blade.php ENDPATH**/ ?>