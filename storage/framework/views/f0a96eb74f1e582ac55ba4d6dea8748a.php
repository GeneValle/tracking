                                ...
                                <tr class="bg-teal-500 hover:bg-teal-700 text-white">
                                    ...
                                    <td class="text-center">
                                        <div class="inline-flex p-2 space-x-3">
                                            <button data-modal-target="editarProductos<?php echo e($producto->id); ?>"
                                                data-modal-toggle="editarProductos<?php echo e($producto->id); ?>"
                                                type="button"
                                            ...
                                            <div id="editarProductos<?php echo e($producto->id); ?>" tabindex="-1"
                                                aria-hidden="true"
                                                class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                <div class="relative w-full max-w-2xl max-h-full">
                                                    <!-- Modal content -->
                                                    <div class="relative bg-white rounded-lg shadow">
                                                        ...
                                                        <div
                                                            ...
                                                            <button type="button"
                                                                class="text-white bg-transparent hover:bg-custom-header hover:text-custom-linksmenu rounded-lg w-8 h-8 ml-auto inline-flex justify-center items-center"
                                                                data-modal-hide="editarProductos<?php echo e($producto->id); ?>">
                                                        ...
                                                        <form action="<?php echo e(route('productos.update', $producto)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ANDF\jetStream\resources\views\productos.blade.php ENDPATH**/ ?>