                        ...
                        <?php $__currentLoopData = $empresas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empresa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tbody>
                                <tr class="bg-teal-500 hover:bg-teal-700 text-white">
                                    ...
                                    <td class="text-center">
                                        <?php echo e($empresa->giro); ?>

                                    </td>
                                    <td class="text-center">
                                        <?php echo e($empresa->sitioWeb); ?>
                                    ...
                                    <td class="text-center">
                                        <div class="inline-flex p-2 space-x-3">
                                            ...
                                            <button type="button"
                                                data-modal-target="editarEmpresa <?php echo e($empresa->id); ?>"
                                                data-modal-toggle="editarEmpresa <?php echo e($empresa->id); ?>"
                                            ...
                                            <div id="editarEmpresa <?php echo e($empresa->id); ?>" tabindex="-1"
                                                aria-hidden="true"
                                                class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                <div class="relative w-full max-w-2xl max-h-full">
                                                    <!-- Modal content -->
                                                    <div class="relative bg-white rounded-lg shadow">
                                                        ...
                                                        <div
                                                            ...
                                                            <button type="button"
                                                                class="text-white bg-transparent hover:bg-custom-header hover:text-custom-linksmenu rounded-lg w-8 h-8 ml-auto inline-flex justify-center items-center"
                                                                data-modal-hide="editarEmpresa <?php echo e($empresa->id); ?>">
                                                        ...
                                                        <form action="<?php echo e(route('empresas.update', $empresa)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
                                                            ...
                                                            <div class="px-6">
                                                                ...
                                                                <div class="my-2">
                                                                    <input type="text"
                                                                        ...
                                                                        value=<?php echo e($empresa->nombreEmpresa); ?>>
                                                                </div>
                                                                ...
                                                                <div class="my-2">
                                                                    <input type="text"
                                                                        ...
                                                                        name="web" id="web"
                                                                        value=<?php echo e($empresa->sitioWeb); ?>>
                                                                </div>
                                                                ...
                                                                <div class="my-2">
                                                                    <input type="text"
                                                                        class="rounded-lg text-custom-morado w-full h-7"
                                                                        name="calle" id="calle"
                                                                        value=<?php echo e($empresa->calle); ?>>
                                                                </div>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="my-2">
                                                                            <input type="text"
                                                                                class="rounded-lg text-custom-morado w-full h-7"
                                                                                name="noExt" id="noExt"
                                                                                value=<?php echo e($empresa->noExterior); ?>>
                                                                        </div>
                                                                    </div>
                                                                    <div>
                                                                        <label for="noInt"
                                                                        ...
                                                                        <div class="my-2">
                                                                            <input type="text"
                                                                                class="rounded-lg text-custom-morado w-full h-7"
                                                                                name="noInt" id="noInt"
                                                                                value=<?php echo e($empresa->noInterior); ?>>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                            ...
                                                                            <select name="colonia" id="colonia"
                                                                                ...
                                                                                <?php $__currentLoopData = $colonias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $colonia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                    <option
                                                                                        ...
                                                                                        <?php if($colonia->id == $empresa->colonias_id): ?> selected <?php endif; ?>>
                                                                                        <?php echo e($colonia->colonia); ?>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="my-2">
                                                                            <input type="text"
                                                                                class="rounded-lg text-custom-morado w-full h-7"
                                                                                name="municipio" id="municipio"
                                                                                value="<?php echo e($empresa->municipio); ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div>
                                                                        <label for="estado"
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="my-2">
                                                                            <input type="text"
                                                                                class="rounded-lg text-custom-morado w-full h-7"
                                                                                name="codPostal" id="codPostal"
                                                                                value=<?php echo e($empresa->codPostal); ?>>
                                                                        </div>
                                                                    </div>
                                                                    <div>
                                                                        <label for="pais"
                                                                ...
                                                                <textarea name="observaciones" id="observaciones" rows="4"
                                                                    ...
                                                                    <?php echo e($empresa->observaciones); ?> 
                                                                </textarea>
                                                            </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ANDF\jetStream\resources\views\empresas.blade.php ENDPATH**/ ?>