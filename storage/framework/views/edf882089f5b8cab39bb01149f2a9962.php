...
<?php $component->withAttributes([]); ?>
    <div class="py-5">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-purple-300 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <form action="<?php echo e(route('reporteDescartados')); ?>" method="GET">
                    <?php echo csrf_field(); ?>
                ...
                <div class="overflow-x-auto  sm:rounded-lg my-6">
                    <?php if($rangoFechas === 'todas'): ?>
                            ...
                            <?php $__currentLoopData = $descartados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $descartado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tbody>
                                    <tr class="bg-teal-500 hover:bg-teal-700 text-white text-lg">
                                        ...
                                        <td class="text-center">
                                            <?php echo e($descartado->totalDescartadosCausa); ?>
                    ...
                    <?php else: ?>
                        <table class="text-sm w-3/4 m-auto text-left text-custom-linksmenu">
                            ...
                            <?php $__currentLoopData = $descartadosPorFecha; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $descartadoPorFecha): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tbody>
                                    <tr class="bg-teal-500 hover:bg-teal-700 text-white text-lg">
                                        <td class="text-center">
                                            <?php echo e($descartadoPorFecha->causa); ?>

                                        </td>
                                        <td class="text-center">
                                            <?php echo e($descartadoPorFecha->totalDescartadosCausaPorFecha); ?>
    ...
    <script>
        ...
        var chartData = {
            labels: <?php echo json_encode($causas); ?>,
            datasets: [{
                label: 'Total Descartados por Causa',
                backgroundColor: 'rgb(75, 192, 192)',
                data: <?php echo json_encode(array_values($totalDescartados)); ?>,
            }]
        };

        <?php if($rangoFechas === 'personalizada'): ?>
            chartData.datasets[0].data = <?php echo json_encode(array_values($totalDescartadosPorFecha)); ?>;
        <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ANDF\jetStream\resources\views\reporteDescartados.blade.php ENDPATH**/ ?>