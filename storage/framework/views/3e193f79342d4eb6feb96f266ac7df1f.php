...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('description', null, []); ?> 
        <?php echo e(__('Eliminar tu cuenta de manera permanente.')); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('content', null, []); ?> 
        <div class="max-w-xl text-sm text-gray-600">
            <?php echo e(__('Una vez que tu cuenta es eliminada, todos tus datos seran elimanados de manera permanente. Antes de eliminar tu cuenta, por favor descarga todos los datos o información que desearías conservar.')); ?>
...
<?php $component->withAttributes(['wire:model.live' => 'confirmingUserDeletion']); ?>
             ...
             <?php $__env->slot('content', null, []); ?> 
                <?php echo e(__('Estas seguro de eliminar tu cuenta? Una vez que tu cuenta es eliminada, todos tus recursos y dato serán eliminados de manera permanente. Por favor ingresa tu contraseña para confirmar que quieres eliminar tu cuenta de manera permanente.')); ?>


                <div class="mt-4" x-data="{}" x-on:confirming-delete-user.window="setTimeout(() => $refs.password.focus(), 250)">
                    <?php if (isset($component)) { $__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['type' => 'password','class' => 'mt-1 block w-3/4','autocomplete' => 'current-password','placeholder' => ''.e(__('Contraseña')).'','xRef' => 'password','wire:model' => 'password','wire:keydown.enter' => 'deleteUser']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'password','class' => 'mt-1 block w-3/4','autocomplete' => 'current-password','placeholder' => ''.e(__('Contraseña')).'','x-ref' => 'password','wire:model' => 'password','wire:keydown.enter' => 'deleteUser']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ANDF\jetStream\resources\views/profile/delete-user-form.blade.php ENDPATH**/ ?>