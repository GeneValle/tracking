        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-purple-300 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="mt-4 ml-6 font-bold text-4xl text-slate-950 flex items-center">
                    ...
                    <!-- Modal toggle -->
                    <button data-modal-target="registroTipoCita" data-modal-toggle="registroTipoCita"
                    ...
                    <div id="registroTipoCita" tabindex="-1" aria-hidden="true"
                            ...
                            <div class="relative bg-white rounded-lg shadow">
                                ...
                                <div class="bg-custom-morado flex items-start justify-between p-4 border-b rounded-t">
                                    ...
                                    <button type="button"
                                        ...
                                        data-modal-hide="registroTipoCita">
                                ...
                                <form action="<?php echo e(route('tipoCita.store')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>

                                    <div class="px-6">
                                        <label for="tipoCita" class="text-base text-custom-morado">Tipo de cita</label>
                                        <div class="my-2">
                                            <input type="text" class="rounded-lg w-full" name="tipoCita"
                                                id="tipoCita">
                                        </div>

                                        <label for="duracion" class="text-base text-custom-morado">Duración
                                            (min)</label>
                                        <div class="my-2">
                                            <input type="text" class="rounded-lg w-full" name="duracion"
                                                id="duracion">
                                        </div>
                                    </div>
                ...
                <div class="my-4 ml-6 font-bold text-2xl text-custom-morado text-center">
                    Listado de tipos de cita disponibles para agendar una cita.
                </div>
                ...
                <div class="overflow-x-auto  sm:rounded-lg my-4">
                    <table class="text-sm w-4/5 text-left text-custom-linksmenu m-auto">
                        ...
                        <?php $__currentLoopData = $tipoCitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipoCita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tbody>
                            <tr class="bg-teal-500 hover:bg-teal-700 text-white">
                                <td class="text-center">
                                    <?php echo e($tipoCita->tipoCita); ?>

                                </td>
                                <td class="text-center">
                                    <?php echo e($tipoCita->duracion); ?>

                                </td>
                                <td class="text-center">
                                    <div class="inline-flex p-2 space-x-3">
                                        <button
                                         data-modal-target="actualizarTipoCita<?php echo e($tipoCita->id); ?>" data-modal-toggle="actualizarTipoCita<?php echo e($tipoCita->id); ?>" 
                                            type="button"
                                        ...
                                        <div id="actualizarTipoCita<?php echo e($tipoCita->id); ?>"  tabindex="-1" aria-hidden="true"
                                            class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                            <div class="relative w-full max-w-2xl max-h-full">
                                                <!-- Modal content -->
                                                <div class="relative bg-white rounded-lg shadow">
                                                    ...
                                                    <div
                                                        ...
                                                        <button type="button"
                                                            class="text-white bg-transparent hover:bg-custom-header hover:text-custom-linksmenu rounded-lg w-8 h-8 ml-auto inline-flex justify-center items-center"
                                                            data-modal-hide="actualizarTipoCita<?php echo e($tipoCita->id); ?>">
                                                    ...
                                                    <form action="<?php echo e(route('tipoCita.update', $tipoCita)); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
                                                        ...
                                                        <div class="px-6">
                                                            ...
                                                            <div class="my-2">
                                                                <input type="text"
                                                                    ...
                                                                    name="tipoCita" id="tipoCita"
                                                                    value="<?php echo e($tipoCita->tipoCita); ?>">
                                                            </div>

                                                            <label for="duracion"
                                                                class="text-base text-custom-morado">Duración
                                                                (min)
                                                            </label>
                                                            <div class="my-2">
                                                                <input type="text"
                                                                    ...
                                                                    value="<?php echo e($tipoCita->duracion); ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="text-right p-2 border-y rounded-b">
                                                            <button data-modal-hide="defaultModal" type="submit"
                                                                class="text-custom-header bg-custom-morado focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-sm px-5 py-2">
                                                                Actualizar tipo de cita</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                        ...
                                        <form action="<?php echo e(route('tipoCita.destroy', $tipoCita)); ?>"  method="POST">
                                            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ANDF\jetStream\resources\views\tipoCita.blade.php ENDPATH**/ ?>