...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo e(__('Autentificación de 2 factores')); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('description', null, []); ?> 
        <?php echo e(__('Añade seguridad adicional para tu cuenta usando la autentiicación de 2 factores')); ?>
        ...
        <h3 class="text-lg font-medium text-gray-900">
            <!--[if BLOCK]><![endif]--><?php if($this->enabled): ?>
                <!--[if BLOCK]><![endif]--><?php if($showingConfirmation): ?>
                    <?php echo e(__('Termine de habilitar la autenticación de 2 factores')); ?>

                <?php else: ?>
                    <?php echo e(__('Ha habilitado la autenticación de 2 factores')); ?>

                <?php endif; ?> <!--[if ENDBLOCK]><![endif]-->
            <?php else: ?>
                <?php echo e(__('No has habilitado la autenticación de 2 factores.')); ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($showingQrCode): ?>
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        <!--[if BLOCK]><![endif]--><?php if($showingConfirmation): ?>
                            <?php echo e(__('Para terminar de habilitar la autenticación de dos factores, escanee el siguiente código QR usando la aplicación de autenticación de su teléfono o ingrese la clave de configuración y proporcione el código OTP generado.')); ?>
                ...
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        <?php echo e(__('Clave de configuracion')); ?>: <?php echo e(decrypt($this->user->two_factor_secret)); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.label','data' => ['for' => 'code','value' => ''.e(__('Código')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ANDF\jetStream\resources\views/profile/two-factor-authentication-form.blade.php ENDPATH**/ ?>