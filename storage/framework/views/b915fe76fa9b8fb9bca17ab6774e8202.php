                                    ...
                                    <div class="my-2">
                                        <select name="lugar" id="lugar"
                                            ...
                                            <?php $__currentLoopData = $citas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($cita->lugar); ?>"><?php echo e($cita->lugar); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                                            ...
                                                            <div class="relative w-full max-w-2xl max-h-full">
                                                                ...
                                                                <div class="relative bg-white rounded-lg shadow">
                                                                    ...
                                                                    <div class="text-right p-2">
                                                                        <button type="button"
                                                                            title="Envia la tarjeta de presentación"
                                                                            class="px-3 py-2 text-xs font-medium text-center inline-flex items-center text-white bg-blue-700 rounded-lg hover:bg-blue-800">
                                                                ...
                                                                <div class="relative bg-white rounded-lg shadow">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="flex flex-wrap">
                                                                            <div class="basis-2/4">
                                                                                <div
                                                                                    class="text-2xl text-custom-morado">
                                                                                    Citas que ha tenido este contacto:
                                                                                </div>
                                                                            </div>
                                                                            <div class="basis-2/4">
                                                                                <button type="button"
                                                                                    onclick="mostrarCitas(<?php echo e($citaVencida->id); ?>)"
                                                                                    class="px-3 py-2 text-xs font-medium text-center inline-flex items-center text-white bg-blue-700 rounded-lg hover:bg-blue-800">
                                                                                    <svg id="tarjetaPresentacion"
                                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                                        height="2em" class="m-auto"
