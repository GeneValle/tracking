            ...
            <div class="bg-purple-300 overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div id="registroTipoCausa" tabindex="-1" aria-hidden="true"
                        ...
                        <div class="relative w-full max-w-2xl max-h-full">
                            ...
                            <div class="relative bg-white rounded-lg shadow">
                                ...
                                <form action="<?php echo e(route('tipoCausa.store')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                ...
                <div class="overflow-x-auto  sm:rounded-lg my-4">
                    <table class="text-sm w-4/5 text-left text-custom-linksmenu m-auto">
                        ...
                        <?php $__currentLoopData = $tipoCausas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipoCausa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tbody>
                                <tr class="bg-teal-500 hover:bg-teal-700 text-white">
                                    <td class="text-center">
                                        <?php echo e($tipoCausa->tipoCausa); ?>

                                    </td>
                                    <td class="text-center">
                                        <div class="inline-flex p-2 space-x-3">

                                            <button data-modal-target="editarTipoCausa<?php echo e($tipoCausa->id); ?>"
                                                data-modal-toggle="editarTipoCausa<?php echo e($tipoCausa->id); ?>" type="button"
                                            ...
                                            <div id="editarTipoCausa<?php echo e($tipoCausa->id); ?>" tabindex="-1"
                                                aria-hidden="true"
                                                class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                <div class="relative w-full max-w-2xl max-h-full">
                                                    <!-- Modal content -->
                                                    <div class="relative bg-white rounded-lg shadow">
                                                        ...
                                                        <div
                                                            ...
                                                            <button type="button"
                                                                class="text-white bg-transparent hover:bg-custom-header hover:text-custom-linksmenu rounded-lg w-8 h-8 ml-auto inline-flex justify-center items-center"
                                                                data-modal-hide="editarTipoCausa<?php echo e($tipoCausa->id); ?>">
                                                        ...
                                                        <form action="<?php echo e(route('tipoCausa.update', $tipoCausa)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
                                                            ...
                                                            <div class="px-6">
                                                                ...
                                                                <div class="my-2">
                                                                    <input type="text"
                                                                        ...
                                                                        value="<?php echo e($tipoCausa->tipoCausa); ?>">
                                                                </div>
                                                            </div>
                                            ...
                                            <form action="<?php echo e(route('tipoCausa.destroy', $tipoCausa)); ?>"
                                                method="POST">
                                                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ANDF\jetStream\resources\views\tipoCausa.blade.php ENDPATH**/ ?>