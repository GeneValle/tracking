                    ...
                    <div id="agregarUsuario" tabindex="-1" aria-hidden="true"
                        ...
                        <div class="relative w-full max-w-2xl max-h-full">
                            ...
                            <div class="relative bg-white rounded-lg shadow">
                                ...
                                <form action="<?php echo e(route('adminUsuarios.store')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="grid grid-cols-2 gap-6 px-4">
                                        ...
                                        <div class="my-3">
                                            ...
                                            <select name="puesto" id="puesto"
                                                ...
                                                <?php $__currentLoopData = $puestoUsuario; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $puesto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($puesto); ?>"><?php echo e($puesto); ?></option>
                                    ...
                                    <div class="w-3/4">
                                        ...
                                        <div class="grid grid-cols-4 gap-1 px-2">
                                            ...
                                            <div class="flex justify-center items-center">
                                                ...
                                                <button data-modal-target="editarUsuario<?php echo e($usuario->id); ?>"
                                                    data-modal-toggle="editarUsuario<?php echo e($usuario->id); ?>"
                                                ...
                                                <div id="editarUsuario<?php echo e($usuario->id); ?>" tabindex="-1"
                                                    aria-hidden="true"
                                                    ...
                                                    <div class="relative w-full max-w-2xl max-h-full">
                                                        ...
                                                        <div class="relative bg-white rounded-lg shadow">
                                                            ...
                                                            <div
                                                                ...
                                                                <button type="button"
                                                                    class="text-white bg-transparent hover:bg-custom-header hover:text-custom-linksmenu rounded-lg w-8 h-8 ml-auto inline-flex justify-center items-center"
                                                                    data-modal-hide="editarUsuario<?php echo e($usuario->id); ?>">
                                                            ...
                                                            <form
                                                                action="<?php echo e(route('adminUsuarios.update', $usuario)); ?>"
                                                                method="POST">
                                                                <?php echo csrf_field(); ?>
                                                                ...
                                                                <div class="grid grid-cols-2 gap-6 px-4">
                                                                    <div class="my-3">
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            value=<?php echo e($usuario->profesion); ?>>
                                                                    </div>
                                                                    <div class="my-3">
                                                                        <label for="password"
                                                                            class="text-base text-custom-morado mx-3">Contraseña:</label>
                                                                ...
                                                                <div class="grid grid-cols-2 gap-6 px-4">
                                                                    ...
                                                                    <div class="my-3">
                                                                        ...
                                                                        <select name="puesto" id="puesto"
                                                                            ...
                                                                            <option value="<?php echo e($puesto); ?>"
                                                                                <?php if($puesto == $usuario->puesto): ?> selected <?php endif; ?>>
                                                                                <?php echo e($usuario->puesto); ?>
                                            ...
                                            <div class="flex justify-center items-center">
                                                ...
                                                <button data-modal-target="eliminarUsuario<?php echo e($usuario->id); ?>"
                                                    data-modal-toggle="eliminarUsuario<?php echo e($usuario->id); ?>"
                                                    class="my-2 text-white bg-blue-600 hover:bg-blue-800 rounded-lg text-center px-2 py-2"
                                                    type="button">
                                                ...
                                                <div id="eliminarUsuario<?php echo e($usuario->id); ?>" tabindex="-1"
                                                    aria-hidden="true"
                                                    class="fixed z-50 hidden w-full p-6 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                    <div class="relative w-full max-w-2xl max-h-full">
                                                        ...
                                                        <div class="relative bg-white rounded-lg shadow">
                                                            ...
                                                            <div
                                                                ...
                                                                <button type="button"
                                                                    class="text-white bg-transparent hover:bg-custom-header hover:text-custom-linksmenu rounded-lg w-8 h-8 ml-auto inline-flex justify-center items-center"
                                                                    data-modal-hide="eliminarUsuario<?php echo e($usuario->id); ?>">
                                                                    <svg class="w-3 h-3" aria-hidden="true"
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                        fill="none" viewBox="0 0 14 14">
                                                                        <path stroke="currentColor"
                                                            ...
                                                            <form
                                                                action="<?php echo e(route('adminUsuarios.destroy', $usuario->id)); ?>"
                                                                method="post">
                                                                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ANDF\jetStream\resources\views\adminUsuarios.blade.php ENDPATH**/ ?>