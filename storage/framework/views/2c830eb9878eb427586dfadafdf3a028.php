...
<?php $component->withAttributes(['submit' => 'updateProfileInformation']); ?>
     ...
     <?php $__env->slot('description', null, []); ?> 
        <?php echo e(__('Actualiza tu información de perfil y tu dirección de correo.')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.label','data' => ['for' => 'photo','value' => ''.e(__('Fotografía')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'photo','value' => ''.e(__('Fotografía')).'']); ?>
...
<?php $component->withAttributes(['class' => 'mt-2 me-2','type' => 'button','x-on:click.prevent' => '$refs.photo.click()']); ?>
                    <?php echo e(__('Selecciona una nueva fotografía')); ?>
...
<?php $component->withAttributes(['type' => 'button','class' => 'mt-2','wire:click' => 'deleteProfilePhoto']); ?>
                        <?php echo e(__('Eliminar Fotografía')); ?>
...
<?php endif; ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if(Laravel\Fortify\Features::enabled(Laravel\Fortify\Features::emailVerification()) && ! $this->user->hasVerifiedEmail()): ?>
                <p class="text-sm mt-2">
                    <?php echo e(__('Tu dirección de correo electrónico no ha sido verificada')); ?>


                    <button type="button" class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" wire:click.prevent="sendEmailVerification">
                        <?php echo e(__('Click aquí para reenviar el correo de verificación.')); ?>
                ...
                <!--[if BLOCK]><![endif]--><?php if($this->verificationLinkSent): ?>
                    <p class="mt-2 font-medium text-sm text-green-600">
                        <?php echo e(__('Un nuevo link de verificación ha sido enviado a tu correo electrónico')); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ANDF\jetStream\resources\views/profile/update-profile-information-form.blade.php ENDPATH**/ ?>