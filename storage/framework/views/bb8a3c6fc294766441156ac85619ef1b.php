        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-purple-300 overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div id="agregarCotizacion" tabindex="-1" aria-hidden="true"
                        ...
                        <div class="relative w-full max-w-2xl max-h-full">
                            ...
                            <div class="relative bg-white rounded-lg shadow">
                                ...
                                <form accept-charset="utf-8" method="POST" action="<?php echo e(route('cotizaciones.store')); ?>">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="my-2">
                                        <select name="prospecto" id="prospecto"
                                            ...
                                            <?php $__currentLoopData = $prospectos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prospecto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($prospecto->id); ?>"><?php echo e($prospecto->nombre); ?></option>
                                    ...
                                    <div id="cotizacion" class="elementosCotizacion" style="display: none">
                                        ...
                                        <input type="hidden" name="fecha" value="<?php echo e(now()); ?>">
                ...
                <div class="rounded-lg  p-6 my-3">
                    <form action="<?php echo e(route('cotizaciones')); ?>" method="get">
                        ...
                        <?php $__currentLoopData = $cotizaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cotizacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tbody class="bg-purple-300 hover:text-custom-header hover:bg-purple-500 text-black">
                                <td class="text-center p-2">
                                    <?php echo e($cotizacion->fecha); ?>

                                </td>
                                <td class="text-center p-2">
                                    <?php echo e($cotizacion->nombre); ?>
                                ...
                                <td class="text-center p-2">
                                    <?php echo e($cotizacion->envios); ?>

                                </td>
                                <td class="text-center p-2">
                                    <?php echo e($cotizacion->visitas); ?>

                                </td>
                                <td class="text-center p-2">
                                    <?php echo e($cotizacion->total); ?>

                                </td>
                                <td class="text-center p-2">
                                    <?php echo e($cotizacion->estado); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ANDF\jetStream\resources\views/cotizaciones.blade.php ENDPATH**/ ?>